...
https:\/\/api\.m\.jd\.com\/client\.action.*functionId=signBean url script-request-header https://raw.githubusercontent.com/sngxpro/scripts/master/
...
var DeleteCookie = true; //是否清除Cookie, true则开启. (该选项仅适用于QX,Surge,Loon,JsBox)
